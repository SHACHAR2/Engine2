...
namespace Engine
{
    class Controller
    {
        ...
        public void Engine(string path, string finalPath, bool stem)
        {
                ...
                while (matchTEXT.Success)
                {
                    ...
                    if (stem)
                    {
                        for (int j = 0; j < terms.Length; j++)
                            stemmer.stemTerm(terms[j].GetName());
                    }
            ...
            while (!(temporarlyPostingFolder1 == 2 && temporarlyPostingFolder2 == 0) || !(temporarlyPostingFolder1 == 0 && temporarlyPostingFolder2 == 2))
            {
                ...
                if (temporarlyPostingFolder1 == 0 && temporarlyPostingFolder2 == 2)
                {
                    ...
                    indexer.FinalMerge(temporarlyPostingFolder[0], temporarlyPostingFolder[1], finalPath);
        ...
        public void Save(string path)
        {
            ...
            string pathDictionery = path + "\\Poodel_Dictionery";
            StreamWriter saveDictionery = new StreamWriter(pathDictionery);
            string pathCache = path + "\\Poodle_Cache";//default
            ...
            {
                saveCache.WriteLine(tempTermList1[i] + "\\" + cache[tempTermList[1]]);
            }
        }
        ...
        {
            string path1 = path + "\\Poodel_Dictionery";
